...
public class MyTableViewer {
		   ...
		   public final static String ID        = "project0920-add-delete-balakrishnan.partdescriptor.tableadddelete"; 
			//project0920-add-delete-balakrishnan.partdescriptor.tableadddelete	   
		   //"simpletableinsertdeleteexample.partdescriptor.simpletabletoinsertanddelete";
		   public final static String POPUPMENU = "project0920-add-delete-balakrishnan.popupmenu.popupmenu";
				   //"simpletableinsertdeleteexample.popupmenu.mypopupmenu";
